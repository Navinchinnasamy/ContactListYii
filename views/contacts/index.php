...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'value'             => 'CHtml::imageButton(Yii::app()->baseUrl."/assets/d6a001ee/gridview/update.png",array("onClick"=>"js:sowUpdateView($data->primaryKey);return false;","title"=>"Edit this Contact","class"=>"contact_actions"))."&nbsp&nbsp".CHtml::imageButton(Yii::app()->baseUrl."/assets/d6a001ee/gridview/delete.png",array("onClick"=>"js:deleteContact($data->primaryKey);return false;","title"=>"Delete this Contact","class"=>"contact_actions"))',
        ),
//        array(
//            'class'=>'CButtonColumn',
